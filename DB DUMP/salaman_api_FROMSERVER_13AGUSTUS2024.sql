...
INSERT INTO `kendaraan` VALUES (10, 'Avanza All New', 'KWK-NTB-05', 'DR 1238 XX', 'mobil', 'KWK-NTB-05.png', NULL, '2024-08-02 11:03:46', '2024-08-13 08:55:59');
...
INSERT INTO `pinjam_kendaraan` VALUES (147, 'Quod ipsum dolores', 'KWNTB01202408101115270003', '2024-08-02', '2024-08-03', 'Pariatur Aut quis q', 'KW-NTB-01', 'KWK-NTB-01', '\"2. Permenkumham M.HH-04.IN.04.02 Tahun 201111-15-27.pdf\"', 'Ditolak', 'Nam aut aut quasi as', '2024-08-10', '2024-08-11');
INSERT INTO `pinjam_kendaraan` VALUES (148, 'Velit sint consequa', 'KWNTB01202408101116080003', '2024-08-02', '2024-08-03', 'Qui quia duis possim', 'KW-NTB-01', 'KWK-NTB-01', '\"1. Permenkumham 57 tahun 2016 tentang pengelolaan11-16-09.pdf\"', 'Disetujui', 'Excepteur sit elit', '2024-08-10', '2024-08-11');
INSERT INTO `pinjam_kendaraan` VALUES (150, 'Eum et atque at numq', 'KWNTB06202408131237310003', '2024-08-14', '2024-08-17', 'Libero iusto dolores', 'KW-NTB-06', 'KWK-NTB-01', '\"2. SOP Kerjasama dengan Pihak Ketiga12-37-31.pdf\"', 'Disetujui', 'Cum aliquam facilis', '2024-08-13', '2024-08-13');
...
-- ----------------------------
INSERT INTO `pinjam_ruangan` VALUES (127, 'Dolores dolores et c', 'KWNTB02202408111141380001', '2024-08-02', '2024-08-03', 'Architecto non earum', 'KW-NTB-02', 'KWR-NTB-01', '\"2. Permenkumham M.HH-04.IN.04.02 Tahun 201111-41-38.pdf\"', 'Ditolak', 'Ratione officia moll', '2024-08-11', '2024-08-12');
INSERT INTO `pinjam_ruangan` VALUES (128, 'Tenetur id culpa pa', 'KWNTB04202408111611550003', '2024-08-02', '2024-08-03', 'Accusantium quis par', 'KW-NTB-04', 'KWR-NTB-01', '\"1. Permenkumham Nomor 65 Tahun 201616-11-55.pdf\"', 'Disetujui', 'Dolorum sit consequ', '2024-08-11', '2024-08-13');
...
CREATE TABLE `pivot_pinjamkendaraan`  (
  ...
  `kode_booking` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `pivot_pinjamkendaraan` VALUES (137, 'KWK-NTB-01', '2024-08-02', 'KWNTB01202408101116080003');
INSERT INTO `pivot_pinjamkendaraan` VALUES (138, 'KWK-NTB-01', '2024-08-03', 'KWNTB01202408101116080003');
INSERT INTO `pivot_pinjamkendaraan` VALUES (143, 'KWK-NTB-01', '2024-08-14', 'KWNTB06202408131237310003');
INSERT INTO `pivot_pinjamkendaraan` VALUES (144, 'KWK-NTB-01', '2024-08-15', 'KWNTB06202408131237310003');
INSERT INTO `pivot_pinjamkendaraan` VALUES (145, 'KWK-NTB-01', '2024-08-16', 'KWNTB06202408131237310003');
INSERT INTO `pivot_pinjamkendaraan` VALUES (146, 'KWK-NTB-01', '2024-08-17', 'KWNTB06202408131237310003');
...
-- ----------------------------
INSERT INTO `pivot_pinjamruangan` VALUES (47, 'KWR-NTB-01', '2024-08-02', 'KWNTB04202408111611550003');
INSERT INTO `pivot_pinjamruangan` VALUES (48, 'KWR-NTB-01', '2024-08-03', 'KWNTB04202408111611550003');
...
CREATE TABLE `salaman`  (
  ...
  `konfigurasi_berita` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `konfigurasi_rekap` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `foto` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of salaman
-- ----------------------------
INSERT INTO `salaman` VALUES (4, 'ADMIN SALAMAN', 'admin', 'USR-NTB-03', 'admin@gmail.com', '2024-01-23 08:05:54', '$2y$10$DSsPE9dssndrDA9vNmjo6.ckdHlqq4Z9/bGXFQpOl2vPJyocCz3jO', NULL, '2024-02-23 15:56:48', '2024-08-13 12:23:31', '12345678', 'superadmin', NULL, NULL, 'USR-NTB-03.png');
INSERT INTO `salaman` VALUES (53, 'johntravolta', 'panggih', 'USR-NTB-04', 'default@gmail.com', NULL, '$2y$10$bUqTffT3Wypb0awVxOOqOeZre1EkUxbMJ9vL/1nzoBm3NPCzHz6be', NULL, '2024-08-08 15:53:45', '2024-08-13 11:55:36', '09876543210', 'rumahtangga', NULL, NULL, 'USR-NTB-04.jpeg');
...
CREATE TABLE `subbidang`  (
  ...
  `email_subbid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `email_verified_at` timestamp(0) NULL DEFAULT NULL,
...
INSERT INTO `subbidang` VALUES (9, 'Penyuluh Hukum', 'KW-NTB-05', NULL, NULL, NULL, NULL, '2024-08-12 00:00:00', NULL);
INSERT INTO `subbidang` VALUES (10, 'Perancang Hukum', 'KW-NTB-06', NULL, NULL, NULL, NULL, '2024-08-12 00:00:00', NULL);
INSERT INTO `subbidang` VALUES (12, 'Pemajuan HAM', 'KW-NTB-07', NULL, NULL, NULL, NULL, '2024-08-13 00:00:00', NULL);
