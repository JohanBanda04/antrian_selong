...
<form action="{{ route('pinjamkendaraanupdate',$pinjamkendaraan->kode_booking) }}" method="post"
      id="frmPinjamKendaraanEdit"
      name="frmPinjamKendaraanEdit"
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3 mt-2">
                ...
                <input type="text" readonly value="{{ $pinjamkendaraan->kode_booking }}" class="form-control"
                       name="kode_booking_pinjam"
                       id="kode_booking_pinjam"
                       placeholder="Kode Booking">
                <input type="hidden" readonly value="{{ $pinjamkendaraan->id }}" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3 mt-2">
                ...
                <input type="text" readonly value="{{ $pinjamkendaraan->perihal_pinjaman }}" class="form-control"
                       name="perihal_pinjam"
                       id="perihal_pinjam"
        ...
        <div class="col-12">
            ...
            <div class="input-icon mb-3 mt-2">
                ...
                "Oktober", "November", "Desember",
                    ...
                    $dari = $pinjamkendaraan->mulai_tgl;
                ...
                @endphp
                <input type="hidden" readonly value="{{ $pinjamkendaraan->mulai_tgl }}" class="form-control"
        ...
        <div class="col-12">
            ...
            <div class="input-icon mb-3 mt-2">
                ...
                "Oktober", "November", "Desember",
                    ...
                    $dari = $pinjamkendaraan->sampai_tgl;
                    $explode_dari = explode('-', $dari);
                    $tgl_dari = $explode_dari[2];
                    $bulan_dari = $explode_dari[1];
                    if (substr($bulan_dari, 0, 1) == 0) {
                ...
                @endphp
                <input type="hidden" readonly value="{{ $pinjamkendaraan->sampai_tgl }}" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3 mt-2">
                ...
                <input type="text" readonly value="{{ $pinjamkendaraan->kode_kendaraan }}" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3 mt-2">
                ...
                @php
                    $get_jeniskendaraan = DB::table('kendaraan')->where('kode_kendaraan', $pinjamkendaraan->kode_kendaraan)->first();
                @endphp
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="input-icon mb-3 mt-2">
                ...
                @php
                    $get_jeniskendaraan = DB::table('kendaraan')->where('kode_kendaraan', $pinjamkendaraan->kode_kendaraan)->first();
                    $name_subbidpeminjam = DB::table("subbidang")->where('kode_subbid',$pinjamkendaraan->kode_subbid)->first()->name_subbid;
    ...
    <div class="row">
        <div class="col-12">
            ...
            <select  name="pilih_persetujuan" id="pilih_persetujuan" class="form-select input-icon mb-3 mt-2">
                <option value="">-Pilih Persetujuan-</option>
                <option {{ $pinjamkendaraan->status=='Pengajuan Pinjaman'?'selected':'' }} value="Pengajuan Pinjaman">Pengajuan Pinjaman</option>
                <option {{ $pinjamkendaraan->status=='Disetujui'?'selected':'' }} value="Disetujui">Setuju</option>
                <option {{ $pinjamkendaraan->status=='Ditolak'?'selected':'' }} value="Ditolak">Tolak</option>
            </select>
        </div>
    </div>
