...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="{{ route('pinjamkendaraan') }}" method="get">
                                        <div class="row">
                                            {{--<div class="col-3">--}}
                                            ...
                                            <div class="col-10">
                                                <div class="form-group">
                                                    <input type="text" name="kode_booking_cari"
                                                           id="kode_booking_cari"
                                                           class="form-control"
                                                           placeholder="Cari Kode Booking"
                                                           value="{{ Request('kode_booking_cari') }}">
                                                </div>
                                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        @foreach($dtpinjamKendaraans as $index=>$dt)
                                            <tr>
                                                <td>{{ ($loop->iteration + $dtpinjamKendaraans->firstItem()) - 1  }}</td>
                                                ...
                                                <td style="text-align: center; ">
                                                    ...
                                                    <label for="label" class="label"
                                                           style="background-color: {{ $class }}; border-radius: 5px; text-align: center">
                                                        {{ ucfirst($dt->status) }}
                                                    </label>
                                                </td>
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap; width: 100px;">
                                                    <div class="btn-group">
                                                        ...
                                                        <a data-toggle="tooltip" title="Beri Persetujuan?" href="#"
                                                           class="edit_pinjamkendaraan btn  btn-sm"
                                                           style="border-radius: 5px; background-color: #19762e"
                                                           kode_booking="{{ $dt->kode_booking }}">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <a data-toggle="tooltip" title="Detail Pinjam Kendaraan???" href="#"
                                                        ...
                                                        <form action="{{ route('pinjamkendaraandelete',$dt->kode_booking) }}"
                                                              method="post"
                                                              style="margin-left: 5px; ">
                                                            @csrf
                                                            {{--cara hack form method--}}
                                                            {{--@method('DELETE')--}}
                                                            <a data-toggle="tooltip" title="Hapus Data Pinjam Kendaraan?"
    ...
    {{--modal untuk edit--}}
    {{--Modal Edit--}}
    <div class="modal modal-blur fade" id="modal-editpinjamkendaraan" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Persetujuan Pinjaman Kendaraan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <div class="modal modal-blur fade" id="modal-tampilkandetail" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    {{--ASLIII--}}
                    <h5 class="modal-title">Detail Data Pinjam Kendaraan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@push('myscript')
    <script>
        $(function () {
            ...
            $('.edit_pinjamkendaraan').click(function () {
                ...
                $('#modal-editpinjamkendaraan').modal('show');
            });
            ...
            $('.tampilkandetail').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('tampilkandetailpinjamkendaraan') }}',
                    cache: false,
                    data: {
                        _token: '{{ csrf_token() }}',
                        kode_booking: kode_booking,
